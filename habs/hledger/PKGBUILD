...
arch=('i686' 'x86_64')
makedepends=()
depends=('gmp' 'ghc' 'haskell-hunit=1.2.2.3' 'haskell-containers=0.4.0.0' 'haskell-csv' 'haskell-directory=1.1.0.0' 'haskell-filepath=1.2.0.0' 'haskell-haskeline<0.7' 'haskell-hledger-lib=0.14' 'haskell-mtl=2.0.1.0' 'haskell-old-locale=1.0.0.2' 'haskell-old-time=1.0.0.6' 'haskell-parsec=3.1.1' 'haskell-process=1.0.1.5' 'haskell-regexpr>=0.5.1' 'haskell-safe>=0.2' 'haskell-split<0.2' 'haskell-time=1.2.0.3' 'haskell-utf8-string<0.4')
options=('strip')
source=(http://hackage.haskell.org/packages/archive/${_hkgname}/${pkgver}/${_hkgname}-${pkgver}.tar.gz)
install=${pkgname}.install
md5sums=('0a6a2c310b398e6f736e72975fde0277')
build() {
